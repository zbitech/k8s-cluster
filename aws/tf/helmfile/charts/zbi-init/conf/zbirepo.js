...
//const zbiUser = cat("/etc/mongodb/admin/ZBI_USERNAME");
//const zbiPass = cat("/etc/mongodb/admin/ZBI_PASSWORD");

//const adminDb = db.getSiblingDB("admin");
//db.createUser({user: "root", pwd: rootPass, roles: [{role: "userAdminAnyDatabase", db: "admin"}]});

const zbiDb = db.getSiblingDB("zbiRepo");
//zbiDb.createUser({user: zbiUser, pwd: zbiPass, roles: [{role: "readWrite", db: "zbiRepo"}]});
...
if(zbi.features.authentication == "local") {
